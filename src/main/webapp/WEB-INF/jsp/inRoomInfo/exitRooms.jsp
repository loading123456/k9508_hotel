    ...
    <form class="layui-form layui-form-pane" action="" lay-filter="exitInRoomInfoForm" style="margin-left: 50px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="number" lay-verify="number|otherPrice" value="0" autocomplete="off" class="layui-input" placeholder="请输入金额" id="otherPrice">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item" style="margin-left: 70px;">
            <button class="layui-btn layui-btn-lg" lay-submit="" lay-filter="demo03"><i class="layui-icon">&#xe605;</i>结账退房</button>
        </div>
    </form>
</div>
